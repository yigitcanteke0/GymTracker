      ...
      if (active) {
        ...
        for (const s of (sets ?? []) as WorkoutSet[]) {
          ...
          group.sets.push({
            ...
            weight_unit: s.weight_unit ?? group.exercise.weight_unit ?? 'kg',
            reps: s.reps ?? 0,
            rir: s.rir ?? 2,
            set_type: s.set_type,
            completed: true,
          ...
          sets: [
            {
              ...
              weight_unit: firstPrev?.weight_unit ?? exercise.weight_unit ?? 'kg',
        ...
        return {
          ...
          sets: [
            ...e.sets,
            {
              ...
              weight_unit: last?.weight_unit ?? e.exercise.weight_unit ?? 'kg',
              reps: last?.reps ?? 10,
              rir: last?.rir ?? 2,
              set_type: 'working' as SetType,
              completed: false,
